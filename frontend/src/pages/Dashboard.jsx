        ...
        <div className="canvas">
            ...
            <div className="glass-wrapper">
                <div className="ultra-sidebar">
                    ...
                    <div className="nav-pill" onClick={() => navigate("/grade-exams")}>Grade Exams</div>
                    <div className="nav-pill" onClick={() => navigate("/notifications-manage")}>Post Notifications</div>
