                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    ...
                    {exams.map(exam => (
                        <tr key={exam.id} style={{ borderBottom: "1px solid #f5f5f5" }}>
                            ...
                            <td style={{ padding: "14px 12px", textAlign: "center", color: "#666" }}>{exam.room?.name || "—"}</td>
                            <td style={{ padding: "14px 12px", textAlign: "center", fontSize: "0.85rem", color: "#666" }}>{new Date(exam.startTime).toLocaleString()}</td>
                            <td style={{ padding: "14px 12px", textAlign: "center", fontSize: "0.85rem", color: "#666" }}>{new Date(exam.endTime).toLocaleString()}</td>
